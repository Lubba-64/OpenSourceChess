...
const sizeVars = [boardSizeCSS, cellSizeCSS, pieceSizeCSS, miniPieceMargainCSS, miniPieceSizeCSS, sideBarWidthCSS, capturedPieceColumnHeightCSS];
function RefreshPlacementCSS(windowSize) {
